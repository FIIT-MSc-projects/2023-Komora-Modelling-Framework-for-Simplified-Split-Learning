...
class bob(object):
    def __init__(self,args):
        ...
        self.alices = {rank+1: rpc.remote(f"alice{rank+1}", alice, (self.server,model_rrefs,rank+1,args.client_model_1,args.client_model_2,args)) for rank in range(args.client_num_in_total)}
