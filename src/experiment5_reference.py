...
def main():
    ...
    logger.info("Using device: ", device, f"({torch.cuda.get_device_name(device)})" if torch.cuda.is_available() else "")
    ...
    for epoch in trange(EPOCHS, desc="Training"):
        ...
        logger.info(f"Epoch {epoch + 1}/{EPOCHS} loss: {train_loss:.2f}")
